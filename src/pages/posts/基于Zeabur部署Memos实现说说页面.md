...
子虚栈的[一分钟免费部署你的专属 Memos](https://blog.si-on.top/2023/deploy-memos-in-60s/)

Leonus的[基于Momos实现说说和清单功能](https://blog.leonus.cn/2023/memeos.html)

# 创建Zeabur并部署Memos

这一步可以直接看子虚栈大佬的教程，已经写得很清楚了，[一分钟免费部署你的专属 Memos](https://blog.si-on.top/2023/deploy-memos-in-60s/)
...
在里面增加以下代码（源自[Leonus - 进一寸有进一寸的欢喜。](https://blog.leonus.cn/))）
...
代码中有一处要修改成你自己的ID，我按照Leonus的教程中关于用户ID获取的方法操作之后，发现本该显示ID的地方显示成了我的用户名![1](https://abnerblog-1317606226.cos.ap-nanjing.myqcloud.com/202308201604729.png)

我原本以为这里的用户名就是我的id，但放到代码中提示是错误的，我在这里卡了好久，在我的一番摸索之下，我发现了一个新的获取id的方法：

点击memos的RSS

![2](https://abnerblog-1317606226.cos.ap-nanjing.myqcloud.com/202308201610379.png)

这里这url中u/后面的数字就是我们的ID

![3](https://abnerblog-1317606226.cos.ap-nanjing.myqcloud.com/202308201612824.png)
...
![4](https://abnerblog-1317606226.cos.ap-nanjing.myqcloud.com/202308201616189.jpg)

# 更多

**关于更多进阶用法，可以去看[基于Momos实现说说和清单功能](https://blog.leonus.cn/2023/memeos.html)**
